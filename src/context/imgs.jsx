...
import e1ans1 from '/sem4/e1ans/1.jpg'
import e1ans2 from '/sem4/e1ans/2.jpg'
import e1ans3 from '/sem4/e1ans/3.jpg'
import e1ans4 from '/sem4/e1ans/4.jpg'
import e1ans5 from '/sem4/e1ans/5.jpg'
import e1ans6 from '/sem4/e1ans/6.jpg'
import e1ans7 from '/sem4/e1ans/7.jpg'
import e1ans8 from '/sem4/e1ans/8.jpg'
import e1ans9 from '/sem4/e1ans/9.jpg'
...
// sem3
// c1
import sem3c1qs1 from '/sem3/c1qs/1.jpg'
import sem3c1qs2 from '/sem3/c1qs/2.jpg'
// c2
...
import sem3c2qs5 from '/sem3/c2qs/5.jpg'
import sem3c2qs6 from '/sem3/c2qs/6.jpg'
...
import sem3c2ans5 from '/sem3/c2ans/5.jpg'
import sem3c2ans6 from '/sem3/c2ans/6.jpg'
import sem3c2ans7 from '/sem3/c2ans/7.jpg'
import sem3c2ans8 from '/sem3/c2ans/8.jpg'
// m1
import sem3m1qs1 from '/sem3/m1qs/1.jpg'
import sem3m1qs2 from '/sem3/m1qs/2.jpg'
// m2
import sem3m2qs1 from '/sem3/m2qs/1.jpg'
import sem3m2qs2 from '/sem3/m2qs/2.jpg'
// e1
import sem3e1qs1 from '/sem3/e1qs/1.jpg'
import sem3e1qs2 from '/sem3/e1qs/2.jpg'
import sem3e1qs3 from '/sem3/e1qs/3.jpg'
import sem3e1qs4 from '/sem3/e1qs/4.jpg'
// e2
import sem3e2qs1 from '/sem3/e2qs/1.jpg'
import sem3e2qs2 from '/sem3/e2qs/2.jpg'
import sem3e2qs3 from '/sem3/e2qs/3.jpg'
import sem3e2qs4 from '/sem3/e2qs/4.jpg'
// eng
import sem3eng from '/sem3/eng/1.jpg'
...
export const ImgsProvider = (props) => {
    ...
    const sem3c1qs = [ sem3c1qs1, sem3c1qs2 ]
    const sem3c2qs = [sem3c2qs4, sem3c2qs3, sem3c2qs2, sem3c2qs1, sem3c2qs5, sem3c2qs6]
    const sem3m1qs = [ sem3m1qs1, sem3m1qs2 ]
    const sem3m2qs = [ sem3m2qs1, sem3m2qs2 ]
    const sem3e1qs = [ sem3e1qs1, sem3e1qs2, sem3e1qs3, sem3e1qs4 ]
    const sem3e2qs = [ sem3e2qs1, sem3e2qs2, sem3e2qs3, sem3e2qs4 ]
    const sem3en = [ sem3eng ]
    // ans
    const e1ans = [e1ans1, e1ans2, e1ans3, e1ans4, e1ans5, e1ans6, e1ans7, e1ans8, e1ans9]
    ...
    const sem3c2ans = [sem3c2ans1, sem3c2ans2, sem3c2ans3, sem3c2ans4, sem3c2ans5 , sem3c2ans6, sem3c2ans7, sem3c2ans8]
    ...
    const sem3c1link = 'https://www.kopykitab.com/index.php?route=pdfviewer/view&product_id=54798&parent_id=5950204'
    const sem3m1link = 'https://www.kopykitab.com/index.php?route=pdfviewer/view&product_id=54892&parent_id=5950204'
    const sem3m2link = 'https://www.kopykitab.com/index.php?route=pdfviewer/view&product_id=54909&parent_id=5950204'
    const sem3e1link = 'https://www.kopykitab.com/index.php?route=pdfviewer/view&product_id=54800&parent_id=5950204'
    const sem3e2link = 'https://www.kopykitab.com/index.php?route=pdfviewer/view&product_id=55268&parent_id=5950204'

    return (
        <ImgsContext.Provider value={{
            // sem4
            c1qs, c2qs, m1qs, m2qs, e1qs, e2qs, 
            e1ans, m2ans, c2ans, c1link, c2link, m1link, m2link, e1link, e2link,
            // sem3 
            sem3c1qs, sem3c2qs, sem3m1qs, sem3m2qs, sem3e1qs, sem3e2qs, sem3en,
            sem3c2ans, sem3c2link, sem3c1link, sem3m1link, sem3m2link, sem3e1link, sem3e2link,
        }} >
            {props.children}
